...
#elif defined( MODULE_ATMEGARFR2 )
#include "atmegarfr2.h"
#include "ieee802154_frame.h"
#define TEXT_SIZE           ATMEGARFR2_MAX_DATA_LENGTH
#define _TC_TYPE            TRANSCEIVER_ATMEGARFR2
...
#if MODULE_AT86RF231 || MODULE_CC2420 || MODULE_MC1322X || MODULE_ATMEGARFR2
